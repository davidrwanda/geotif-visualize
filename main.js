...
class AfricaBoundariesMap {
    constructor() {
        ...
        this.countryTifUrls = {
            'Senegal': 'https://www.aagwa.org/customized-aagwa/data/Senegal/Groundnut/production/2024/Senegal_Groundnut_production_2024.tif',
            'Benin': '',
            'Ghana': '',
            'Malawi': '',
            'Uganda': ''
    ...
    async init() {
        try {
            ...
            console.log('✅ Africa Boundaries Map initialized successfully!');
            
        } catch (error) {
            console.error('❌ Error initializing Africa Boundaries Map:', error);
    ...
    createTifLegend() {
        ...
        this.currentLegend.onAdd = (map) => {
            ...
            title.textContent = `2024 predicted Groundnut production in ${this.currentCountry} (in g/100m²)`;
            title.style.cssText = `
                margin: 0 0 15px 0;
                font-size: 14px;
                color: #2E5A3C;
        ...
        console.log('✅ TIF legend created');
    }
...
console.log('🚀 Africa Boundaries Map application loaded');
